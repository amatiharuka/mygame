;メッセージレイヤの定義
		...
		[position width=600 height=250 top=650 left=20 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=45 y=660 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=600 height=250 top=650 left=20 ]
